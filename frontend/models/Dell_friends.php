...
class Dell_friends extends Model
{
    public $id;   
    ...
    public function Dell()
    {
        ...
        if($this_users->status == 0){
            
            $friends = Users_friends::find()->where('id_user = :id_user', [':id_user' => $this->id])->andWhere( 'id_friend = :id_friend', [':id_friend' => Yii::$app->user->id])->one();       
