...
class Dell_application extends Model
{
    public $id;   
    ...
    public function Dell()
    {
        ...
        if($this_users->status == 1){
            
            $application_users = Users_friends::find()->where('id_user = :id_user', [':id_user' => $this->id])->andWhere( 'id_friend = :id_friend', [':id_friend' => Yii::$app->user->id])->one();       
            
            $this_users->delete();
            
            $application_users->delete();
